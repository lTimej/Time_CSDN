...
from caches import statistics as cache_statistic
...
def fix_statistics(flask_app):
    ...
    with flask_app.app_context():
        __fix_statistics(cache_statistic.UserArticleCount)

        __fix_statistics(cache_statistic.UserFocusCount)

        __fix_statistics(cache_statistic.ArticleCollectionCount)

        __fix_statistics(cache_statistic.UserCollectionCount)
