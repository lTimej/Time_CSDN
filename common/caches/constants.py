...
# 默认用户头像
DEFAULT_USER_PROFILE_PHOTO = 'group1/M00/00/00/wKiZgmCOpa6AbvCXAAEwN58xN6E181.png'  # 程序猿

# 阅读历史每人保存数目
READING_HISTORY_COUNT_PER_USER = 100

# 用户搜索历史每人保存数目
SEARCHING_HISTORY_COUNT_PER_USER = 5
...
# 匿名用户用户频道缓存有效期，秒
ANONY_USER_CHANNELS_CACHE_TTL = 24 * 60 * 60

# 全部频道缓存有效期，秒
ALL_CHANNELS_CACHE_TTL = 24 * 60 * 60 * 14
